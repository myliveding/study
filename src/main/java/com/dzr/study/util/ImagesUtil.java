...
public class ImagesUtil {
    ...
    private static ImagesUtil imageHelper = null;

    public static ImagesUtil getImageHelper() {
        if (imageHelper == null) {
            imageHelper = new ImagesUtil();
        }
        return imageHelper;
    }
    ...
    public static void main(String[] args) {
        ...
        scaleImageWithParams("e:/filein/DSC_0016.jpg", "e:/fileout/1.jpg", 80, 80, true, "png");
