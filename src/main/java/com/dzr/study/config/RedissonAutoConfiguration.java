...
import com.dzr.study.util.DataUtils;
...
public class RedissonAutoConfiguration {
    ...
    protected class RedissonSingleClientConfiguration {
        ...
        RedissonClient redissonSingle() {
            ...
            SingleServerConfig serverConfig = config.useSingleServer().setAddress(node).setTimeout(redisConfig.getPool().getConnTimeout())
                    .setDatabase(redisConfig.getDatabase())
                    .setConnectionPoolSize(redisConfig.getPool().getSize()).setConnectionMinimumIdleSize(redisConfig.getPool().getMinIdle());
            if (DataUtils.isNotEmpty(redisConfig.getPassword())) {
        ...
        RedissonClient redissonCluster() {
            System.out.println("cluster redisProperties:" + redisConfig.getCluster());
            Config config = new Config();
            ...
            ClusterServersConfig serverConfig = config.useClusterServers().addNodeAddress(newNodes.toArray(new String[0]))
                    ...
                    .setIdleConnectionTimeout(redisConfig.getPool().getSoTimeout())
                    .setConnectTimeout(redisConfig.getPool().getConnTimeout())
                    .setFailedSlaveCheckInterval(redisConfig.getCluster().getFailedAttempts())
        ...
        RedissonClient redissonSentinel() {
            System.out.println("sentinel redisProperties:" + redisConfig.getSentinel());
            Config config = new Config();
